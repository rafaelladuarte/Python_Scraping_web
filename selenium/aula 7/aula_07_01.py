...
f = Firefox()
f.get("https://selenium.dunossauro.live/aula_07_d")

input_texto = f.find_element_by_tag_name("input")
span = f.find_element_by_tag_name("span")
p = f.find_element_by_tag_name("p")
